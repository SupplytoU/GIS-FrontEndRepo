    ...
    <>
        <div className='FarmerSidebar'data-theme={isDark ? "dark" : "light"}>
            <div className='DashTitle'>
                <img className='DashboardIcon' src={icon}/>
                <h6>Dashboard</h6>
            </div>
            <div className='FarmerLinks'>
                <div className='Location'>
                    <img className='PlaceMarker' src = {locations}/>
                    <p>View Locations</p>
                </div>
                <div className='Location'>
                    <img className='PlaceMarker' src = {farm}/>
                    <p>Add Farms</p>
                </div>
                <div className='Location'>
                    <img className='PlaceMarker' src = {field}/>
                    <p>Add Fields</p>
                </div>
                <div className='Location'>
                    <img className='PlaceMarker' src = {track}/>
                    <p>Track Delivery</p>
                </div>
                <div className='Location'>
                    <img className='PlaceMarker' src = {settings}/>
                    <p>Settings</p>
                </div>
            </div>
